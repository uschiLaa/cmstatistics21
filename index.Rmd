...
.center[<img src="plots/4D_proj.png" width="49%">]

---
# What is hidden in projections?

.center[<img src="plots/4D_proj.png" width="49%"> <img src="plots/4D_slice.png" width="49%">]
...
**Example**: Classification problem from physics (PDFSense data), with three groups in six dimensions. The three groups approximately share the same mean, but extend in different directions of parameter space. When fitting a SVM with radial kernel we find that across most of the parameter space we predict one of the three groups. Where are sections with predictions for the other two?
